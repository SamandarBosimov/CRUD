...
function checkInputs(){
    if(name.value == "" || data.value == "" || ball.value == ""){
    ...
    data.sort(function (a, b) {return b.ball - a.ball}).map((obj, id) => {
        return (
            ...
            <tr>
                ...
                <td>${obj.date}</td>
                <td>${obj.ball}</td>
                <td><i class="fa-solid fa-pen-to-square" onclick="editData(${obj.id})" style="color: yellow;"></i></td>
                <td><i class="fa-solid fa-trash" onclick="deleteData(${obj.id})" style="color: red;"></i></td>
            </tr>
            `
        );
    });
